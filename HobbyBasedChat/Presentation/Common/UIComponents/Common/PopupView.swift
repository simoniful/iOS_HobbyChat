...
final class PopupView: UIView {
  ...
  private let titleLabel = BaseLabel(font: .title3M14, textColor: .black)
  private let messageLabel = BaseLabel(font: .title4R14, textColor: .green)
  private let reviewSelectionView = SesacCardTitleView()
  private let reportSelectionView = SesacCardReportView()
  ...
  convenience init(
    ...
    self.style = style
    self.setupAttributes(style: style)
  ...
  private func setupAttributes(style: PopupStyle) {
  ...
  func showPopup() {
    self.setupView(style: self.style)
    self.setAnimation()
  }
  ...
  private func setupView(style: PopupStyle) {
