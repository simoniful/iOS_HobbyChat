//
//  ShopBackgroundItemViewModel.swift
//  HobbyBasedChat
//
...
final class ShopBackgroundItemViewModel: ViewModel {
  private let useCase: ShopBackgroundItemUseCase
  ...
  init(useCase: ShopBackgroundItemUseCase) {
...
extension ShopBackgroundItemViewModel {
