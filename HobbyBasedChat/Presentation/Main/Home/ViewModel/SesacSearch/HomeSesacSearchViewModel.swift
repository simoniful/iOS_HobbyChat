//
//  HomeSesacSearchViewModel.swift
//  HobbyBasedChat
//
...
final class HomeSesacSearchViewModel: ViewModel {
  private weak var coordinator: HomeCoordinator?
  private let useCase: HomeSesacSearchUseCase
...
extension HomeSesacSearchViewModel {
  private func makeNearSesacItem(onqueue: Onqueue) -> [SesacDB] {
    return onqueue.fromSesacDB
  }
  
  private func makeReceivedRequestItem(onqueue: Onqueue) -> [SesacDB] {
    return onqueue.fromSesacDBRequested
  }
