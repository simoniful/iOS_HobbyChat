...
final class HomeChatViewModel: ViewModel {
  private weak var coordinator: HomeCoordinator?
  private let useCase: HomeChatUseCase
  ...
  init(coordinator: HomeCoordinator?, useCase: HomeChatUseCase) {
